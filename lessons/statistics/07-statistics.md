...
Remember P(a|b) = P(b|a) * P(a) / P(b), though it's not really needed here

```
p_frat = 1/125
p_ident = 1/300

p_twin = p_frat + p_ident

p_twin_given_ident = 1 # Because duh

p_identical_given_twin = p_twin_given_ident * p_ident / p_twin
```
